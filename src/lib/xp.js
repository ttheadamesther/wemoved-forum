...
export const BADGES_DEF = [
  { key: 'flash',   emoji: '⚡', label: 'Pionnier',      desc: 'Parmi les premiers membres',  color: '#3b82f6', bg: '#dbeafe' },
  ...
  { key: 'fire',    emoji: '🔥', label: 'Incontournable', desc: 'Reçu 100 votes',             color: '#ef4444', bg: '#fee2e2' },
  { key: 'friend',  emoji: '🤝', label: 'Sociable',      desc: '5 amis acceptés',             color: '#06b6d4', bg: '#cffafe' },
