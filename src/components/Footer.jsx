...
export default function Footer() {
  return (
    <footer style={{ marginTop: 'auto', borderTop: `1px solid ${C.border}`, padding: '20px 16px', textAlign: 'center', fontSize: 11, color: C.textDim, background: C.surfaceB }}>
      <div style={{ maxWidth: 960, margin: '0 auto', display: 'flex', flexWrap: 'wrap', justifyContent: 'center', alignItems: 'center', gap: '8px 20px' }}>
        ...
        <Link to="/rewards" style={{ color: C.textDim, textDecoration: 'none', fontWeight: 600 }}
          onMouseEnter={e => e.currentTarget.style.color = C.accentTxt}
          onMouseLeave={e => e.currentTarget.style.color = C.textDim}>
          🏆 Récompenses
        </Link>
        <span style={{ color: C.border }}>|</span>
        <Link to="/rankings" style={{ color: C.textDim, textDecoration: 'none', fontWeight: 600 }}
          onMouseEnter={e => e.currentTarget.style.color = C.accentTxt}
          onMouseLeave={e => e.currentTarget.style.color = C.textDim}>
          📊 Classements
        </Link>
